        ...
        for (let r = 1; r < this.numRows; r++) { // start at row after headers
            ...
            for (let c = 0; c < this.numCols; c++) {
                if (this.coverMat[r][c] == 1) {
                    ...
                    newNode.column.up.down = newNode.up;
                    ...
                    if (!refNode) { // case where refNode is null, first iter
                        refNode = newNode;
                    }
